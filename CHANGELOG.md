...
- **Stability**: `ServerDeactivate` now cancels pending requests and drains callbacks before the module is fully deactivated, preventing callback execution on unloaded AMX plugins during map changes.
